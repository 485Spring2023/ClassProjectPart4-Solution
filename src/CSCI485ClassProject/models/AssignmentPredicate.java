...
public class AssignmentPredicate {
  ...
  public AssignmentPredicate(String subjectAttrName, ComparisonOperator operator, Object operandValue) {
    this.subjectAttrName = subjectAttrName;
    this.operator = operator;
    this.operandValue = operandValue;
  }

  public AssignmentPredicate(String subjectAttrName, ComparisonOperator operator, String operandAttrName) {
    this.subjectAttrName = subjectAttrName;
    this.operator = operator;
